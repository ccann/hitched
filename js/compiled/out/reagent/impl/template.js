...
var G__46195 = o;
(G__46195[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
G__46196.cljs$lang$applyTo = (function (arglist__46198){
...
var G__46202 = jsprops;
(G__46202["defaultValue"] = value);

(G__46202["onChange"] = ((function (G__46202,v,value,on_change){
return (function (p1__46200_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46200_SHARP_);
});})(G__46202,v,value,on_change))
);

(G__46202["ref"] = ((function (G__46202,v,value,on_change){
return (function (p1__46201_SHARP_){
return (this$["cljsInputElement"] = p1__46201_SHARP_);
});})(G__46202,v,value,on_change))
);
...
var vec__46205 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46205,(0),null);
var id = cljs.core.nth.call(null,vec__46205,(1),null);
var class$ = cljs.core.nth.call(null,vec__46205,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___46209 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___46209 == null)){
} else {
var key_46210 = temp__4661__auto___46209;
(jsprops["key"] = key_46210);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__46211 = (new reagent.impl.template.NativeWrapper());
(G__46211["name"] = c);
...
var len__34830__auto___46216 = arguments.length;
var i__34831__auto___46217 = (0);
while(true){
if((i__34831__auto___46217 < len__34830__auto___46216)){
args__34837__auto__.push((arguments[i__34831__auto___46217]));

var G__46218 = (i__34831__auto___46217 + (1));
i__34831__auto___46217 = G__46218;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46214){
var G__46215 = cljs.core.first.call(null,seq46214);
var seq46214__$1 = cljs.core.next.call(null,seq46214);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46215,seq46214__$1);
});
...
break;
default:
var G__46221 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46221;
continue;
...
var n__34629__auto___46223 = a.length;
var i_46224 = (0);
while(true){
if((i_46224 < n__34629__auto___46223)){
(a[i_46224] = reagent.impl.template.as_element.call(null,(a[i_46224])));

var G__46225 = (i_46224 + (1));
i_46224 = G__46225;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__34629__auto___46226 = a.length;
var i_46227 = (0);
while(true){
if((i_46227 < n__34629__auto___46226)){
var val_46228 = (a[i_46227]);
if((cljs.core.vector_QMARK_.call(null,val_46228)) && ((reagent.impl.template.key_from_vec.call(null,val_46228) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46227] = reagent.impl.template.as_element.call(null,val_46228));

var G__46229 = (i_46227 + (1));
i_46227 = G__46229;
continue;
} else {
}
...
var ctx = ({});
var vec__46230 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46230,(0),null);
var derefed = cljs.core.nth.call(null,vec__46230,(1),null);
...
var G__46233 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46233) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46233){
...
//# sourceMappingURL=template.js.map?rel=1514142713400