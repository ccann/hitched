...
return cljs.core.reduce.call(null,(function (m,p__36671){
var vec__36672 = p__36671;
var k = cljs.core.nth.call(null,vec__36672,(0),null);
var vs = cljs.core.nth.call(null,vec__36672,(1),null);
...
var vec__36675 = temp__4655__auto__;
...
var node = first__36677;
var more = seq__36676__$1;
if(cljs.core.contains_QMARK_.call(null,expanded,node)){
var G__36678 = more;
var G__36679 = expanded;
unexpanded = G__36678;
expanded = G__36679;
continue;
} else {
var G__36680 = cljs.core.concat.call(null,more,neighbors.call(null,node));
var G__36681 = cljs.core.conj.call(null,expanded,node);
unexpanded = G__36680;
expanded = G__36681;
continue;
}
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__34333__auto__,k36683,else__34334__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k36683,else__34334__auto__);
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36682){
var self__ = this;
var G__36682__$1 = this;
return (new cljs.core.RecordIter((0),G__36682__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36684,other36685){
var self__ = this;
var this36684__$1 = this;
return (!((other36685 == null))) && ((this36684__$1.constructor === other36685.constructor)) && (cljs.core._EQ_.call(null,this36684__$1.dependencies,other36685.dependencies)) && (cljs.core._EQ_.call(null,this36684__$1.dependents,other36685.dependents)) && (cljs.core._EQ_.call(null,this36684__$1.__extmap,other36685.__extmap));
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__34338__auto__,k__34339__auto__,G__36682){
var self__ = this;
var this__34338__auto____$1 = this;
var pred__36688 = cljs.core.keyword_identical_QMARK_;
var expr__36689 = k__34339__auto__;
if(cljs.core.truth_(pred__36688.call(null,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),expr__36689))){
return (new com.stuartsierra.dependency.MapDependencyGraph(G__36682,self__.dependents,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__36688.call(null,new cljs.core.Keyword(null,"dependents","dependents",136812837),expr__36689))){
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,G__36682,self__.__meta,self__.__extmap,null));
} else {
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__34339__auto__,G__36682),null));
}
}
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__34330__auto__,G__36682){
var self__ = this;
var this__34330__auto____$1 = this;
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,G__36682,self__.__extmap,self__.__hash));
});
...
com.stuartsierra.dependency.map__GT_MapDependencyGraph = (function com$stuartsierra$dependency$map__GT_MapDependencyGraph(G__36686){
return (new com.stuartsierra.dependency.MapDependencyGraph(new cljs.core.Keyword(null,"dependencies","dependencies",1108064605).cljs$core$IFn$_invoke$arity$1(G__36686),new cljs.core.Keyword(null,"dependents","dependents",136812837).cljs$core$IFn$_invoke$arity$1(G__36686),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__36686,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837))),null));
});
...
return cljs.core.empty_QMARK_.call(null,com.stuartsierra.dependency.immediate_dependents.call(null,graph,p1__36692_SHARP_));
});})(sorted,g))
...
var vec__36693 = cljs.core.seq.call(null,todo);
var seq__36694 = cljs.core.seq.call(null,vec__36693);
var first__36695 = cljs.core.first.call(null,seq__36694);
var seq__36694__$1 = cljs.core.next.call(null,seq__36694);
var node = first__36695;
var more = seq__36694__$1;
var deps = com.stuartsierra.dependency.immediate_dependencies.call(null,g,node);
var vec__36696 = (function (){var deps__$1 = deps;
var g__$1 = g;
...
var G__36699 = cljs.core.rest.call(null,deps__$1);
var G__36700 = g_SINGLEQUOTE_;
var G__36701 = cljs.core.conj.call(null,add,d);
deps__$1 = G__36699;
g__$1 = G__36700;
add = G__36701;
continue;
} else {
var G__36702 = cljs.core.rest.call(null,deps__$1);
var G__36703 = g_SINGLEQUOTE_;
var G__36704 = add;
deps__$1 = G__36702;
g__$1 = G__36703;
add = G__36704;
...
var add = cljs.core.nth.call(null,vec__36696,(0),null);
var g_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__36696,(1),null);
var G__36705 = cljs.core.cons.call(null,node,sorted);
var G__36706 = com.stuartsierra.dependency.remove_node.call(null,g_SINGLEQUOTE_,node);
var G__36707 = clojure.set.union.call(null,cljs.core.set.call(null,more),cljs.core.set.call(null,add));
sorted = G__36705;
g = G__36706;
todo = G__36707;
continue;
...
//# sourceMappingURL=dependency.js.map?rel=1514095997309