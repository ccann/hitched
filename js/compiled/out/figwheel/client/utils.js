...
return (new CustomEvent(event_name,(function (){var obj49586 = {"detail":data};
return obj49586;
})()));
} else {
...
var f = (function (){var pred__49593 = cljs.core._EQ_;
var expr__49594 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49593.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49594))){
return ((function (pred__49593,expr__49594){
return (function (p1__49587_SHARP_){
return console.warn(p1__49587_SHARP_);
});
;})(pred__49593,expr__49594))
} else {
if(cljs.core.truth_(pred__49593.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49594))){
return ((function (pred__49593,expr__49594){
return (function (p1__49588_SHARP_){
return console.debug(p1__49588_SHARP_);
});
;})(pred__49593,expr__49594))
} else {
if(cljs.core.truth_(pred__49593.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49594))){
return ((function (pred__49593,expr__49594){
return (function (p1__49589_SHARP_){
return console.error(p1__49589_SHARP_);
});
;})(pred__49593,expr__49594))
} else {
return ((function (pred__49593,expr__49594){
return (function (p1__49590_SHARP_){
return console.log(p1__49590_SHARP_);
});
;})(pred__49593,expr__49594))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49597){
...
var opts = map__49598__$1;
var eval_fn = cljs.core.get.call(null,map__49598__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49600_SHARP_);
});})(new_def))
);
...
return (function (p__49601){
var vec__49602 = p__49601;
var ky = cljs.core.nth.call(null,vec__49602,(0),null);
var v = cljs.core.nth.call(null,vec__49602,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1514142717502