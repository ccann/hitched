...
var or__33705__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj40964 = {"detail":data};
return obj40964;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__33693__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__33693__auto__)){
var and__33693__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__40971 = cljs.core._EQ_;
var expr__40972 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40971.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40972))){
return ((function (pred__40971,expr__40972){
return (function (p1__40965_SHARP_){
return console.warn(p1__40965_SHARP_);
});
;})(pred__40971,expr__40972))
} else {
if(cljs.core.truth_(pred__40971.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40972))){
return ((function (pred__40971,expr__40972){
return (function (p1__40966_SHARP_){
return console.debug(p1__40966_SHARP_);
});
;})(pred__40971,expr__40972))
} else {
if(cljs.core.truth_(pred__40971.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40972))){
return ((function (pred__40971,expr__40972){
return (function (p1__40967_SHARP_){
return console.error(p1__40967_SHARP_);
});
;})(pred__40971,expr__40972))
} else {
return ((function (pred__40971,expr__40972){
return (function (p1__40968_SHARP_){
return console.log(p1__40968_SHARP_);
});
;})(pred__40971,expr__40972))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40975){
...
var eval_fn = cljs.core.get.call(null,map__40976__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__40978_SHARP_){
return new_def.callback(p1__40978_SHARP_);
});})(new_def))
);
...
return (function (p__40979){
var vec__40980 = p__40979;
var ky = cljs.core.nth.call(null,vec__40980,(0),null);
var v = cljs.core.nth.call(null,vec__40980,(1),null);
...
if(cljs.core.truth_((function (){var and__33693__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1514096001214